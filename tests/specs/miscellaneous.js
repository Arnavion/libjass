...
suite("Miscellaneous", function () {
	test("herkz", parserTest("{\\pos(311,4)\\blur0.8\\fs40\\bord0\\c&H3F171F&\\t(3820,3820,\\blur6}Chi{\\c&H422CB1&}tose {\\c&H3F171F&}Furu", "dialogueParts", [
	...
	test("herkz-fixed", parserTest("{\\pos(311,4)\\blur0.8\\fs40\\bord0\\c&H3F171F&\\t(3820,3820,\\blur6)}Chi{\\c&H422CB1&}tose {\\c&H3F171F&}Furu", "dialogueParts", [
		new libjass.parts.Position(311, 4),
		new libjass.parts.GaussianBlur(0.8),
		new libjass.parts.FontSize(40),
		new libjass.parts.Border(0),
	...
	test("klk-01", parserTest("{\\an5\\bord0\\blur1\\p1\\c&H97B9D6&\\pos(143.39,358.77)\\frz334.3\\fscx39\\fscy47\\iclip(m 129 338 l 121 381 110 372 110 331)}m 0 0 l 100 0 100 100 0 100", "dialogueParts", [
	...
	test("chihaya-16", parserTest("{\\an7\\pos(0,0)\\bord0\\blur0.5\\p1\\c&HFAFAFA&}m 88 644 l 87 681 l 255 681 l 256 643 m 311 643 l 310 681 l 482 681 l 483 641 m 562 641 l 561 679 l 730 676 l 731 640 m 800 638 l 798 677 l 968 676 l 970 639 m 1031 638 l 1028 675 l 1200 674 l 1200 640 {p0}", "dialogueParts", [
	...
	test("ASS", function (done) {
		...
		libjass.ASS.fromString(input, libjass.Format.ASS).then(function (ass) {
			try {
				assert.deepEqual(ass.properties.resolutionX, 1280);
				assert.deepEqual(ass.properties.resolutionY, 720);
				assert.deepEqual(ass.properties.wrappingStyle, libjass.WrappingStyle.SmartWrappingWithWiderTopLine);
				assert.deepEqual(ass.properties.scaleBorderAndShadow, true);

				assert.deepEqual(ass.styles.size, 3);

				assert.deepEqual(ass.styles.get("Default").name, "Default");
				assert.deepEqual(ass.styles.get("Default").italic, false);
				assert.deepEqual(ass.styles.get("Default").bold, false);
				assert.deepEqual(ass.styles.get("Default").underline, false);
				assert.deepEqual(ass.styles.get("Default").strikeThrough, false);
				assert.deepEqual(ass.styles.get("Default").fontName, "Arial");
				assert.deepEqual(ass.styles.get("Default").fontSize, 50);
				assert.deepEqual(ass.styles.get("Default").fontScaleX, 1);
				assert.deepEqual(ass.styles.get("Default").fontScaleY, 1);
				assert.deepEqual(ass.styles.get("Default").letterSpacing, 0);
				assert.deepEqual(ass.styles.get("Default").rotationZ, 0);
				...
				assert.deepEqual(ass.styles.get("Default").outlineThickness, 1.5);
				assert.deepEqual(ass.styles.get("Default").borderStyle, libjass.BorderStyle.Outline);
				assert.deepEqual(ass.styles.get("Default").shadowDepth, 0);
				assert.deepEqual(ass.styles.get("Default").alignment, 2);
				assert.deepEqual(ass.styles.get("Default").marginLeft, 80);
				assert.deepEqual(ass.styles.get("Default").marginRight, 80);
				assert.deepEqual(ass.styles.get("Default").marginVertical, 35);

				assert.deepEqual(ass.dialogues.length, 6);

				assert.deepEqual(ass.dialogues[0].start, 263.700);
				assert.deepEqual(ass.dialogues[0].end, 267.950);
				assert(ass.dialogues[0].style === ass.styles.get("sign1"));
				assert.deepEqual(ass.dialogues[0].style, ass.styles.get("sign1"));
				...
				assert.deepEqual(ass.dialogues[3].start, 0.000);
				assert.deepEqual(ass.dialogues[3].end, 0.000);
				assert(ass.dialogues[3].style === ass.styles.get("Default"));
				assert.deepEqual(ass.dialogues[3].parts, []);

				assert.deepEqual(ass.dialogues[4].start, 75.940);
				assert.deepEqual(ass.dialogues[4].end, 77.280);
				assert(ass.dialogues[4].style === ass.styles.get("Default"));
	...
	test("ASS", function (done) {
		...
		libjass.ASS.fromString(input, libjass.Format.ASS).then(function (ass) {
			try {
				...
				assert.deepEqual(ass.styles.get("Default").name, "Default");
				assert.deepEqual(ass.styles.get("Default").italic, false);
				assert.deepEqual(ass.styles.get("Default").bold, true);
				assert.deepEqual(ass.styles.get("Default").underline, false);
				assert.deepEqual(ass.styles.get("Default").strikeThrough, false);
				assert.deepEqual(ass.styles.get("Default").fontName, "Arial");
				assert.deepEqual(ass.styles.get("Default").fontSize, 51);
				assert.deepEqual(ass.styles.get("Default").fontScaleX, 1);
				assert.deepEqual(ass.styles.get("Default").fontScaleY, 1);
				assert.deepEqual(ass.styles.get("Default").letterSpacing, 0);
				assert.deepEqual(ass.styles.get("Default").rotationZ, 0);
				...
				assert.deepEqual(ass.styles.get("Default").outlineThickness, 3);
				assert.deepEqual(ass.styles.get("Default").borderStyle, libjass.BorderStyle.Outline);
				assert.deepEqual(ass.styles.get("Default").shadowDepth, 1);
				assert.deepEqual(ass.styles.get("Default").alignment, 2);
				assert.deepEqual(ass.styles.get("Default").marginLeft, 110);
				assert.deepEqual(ass.styles.get("Default").marginRight, 110);
				assert.deepEqual(ass.styles.get("Default").marginVertical, 40);

				assert.deepEqual(ass.dialogues.length, 9);

				assert.deepEqual(ass.dialogues[0].start, 646.460);
				assert.deepEqual(ass.dialogues[0].end, 652.130);
				assert(ass.dialogues[0].style === ass.styles.get("op trans"));
				assert.deepEqual(ass.dialogues[0].parts, [
					new libjass.parts.Fade(0.2, 0),
					new libjass.parts.Text("Sapien rhoncus, suscipit posuere in nunc pellentesque")
				]);

				assert.deepEqual(ass.dialogues[3].start, 646.460);
				assert.deepEqual(ass.dialogues[3].end, 646.660);
				assert(ass.dialogues[3].style === ass.styles.get("op kara"));
				assert.deepEqual(ass.dialogues[3].parts, [
					new libjass.parts.Fade(0.2, 0),
					new libjass.parts.Comment("("),
				...
				assert.deepEqual(ass.dialogues[6].start, 3.370);
				assert.deepEqual(ass.dialogues[6].end, 7.940);
				assert(ass.dialogues[6].style === ass.styles.get("Default"));
