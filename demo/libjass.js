...
(function (root, factory) {
    ...
    def("renderers/web/renderer", [ "renderers/web/animation-collection", "renderers/web/drawing-styles", "renderers/web/font-size", "renderers/web/keyframe", "renderers/web/span-styles", "renderers/clocks/base", "renderers/null", "parser/ttf", "parts/index", "settings", "types/attachment", "types/misc", "utility/mixin", "utility/map", "utility/promise" ], function (animation_collection_1, drawing_styles_1, font_size_2, keyframe_1, span_styles_1, base_3, null_1, ttf_1, parts, settings_9, attachment_2, misc_8, mixin_3, map_14, promise_7, exports) {
                ...
                fontMap.forEach(function (srcs, fontFamily) {
                    ...
                    if (global.document.fonts && global.document.fonts.add) {
                        ...
                        if (existingFontFaces_1.length === 0) {
                            var fontFace = new FontFace(fontFamily, source_1);
    ...
    def("parser/ttf", [ "utility/map", "utility/set" ], function (map_13, set_1, exports) {
        var DataType;
        (function (DataType) {
        ...
        var fieldDecorators = new map_13.Map();
    ...
    def("renderers/web/animation-collection", [ "utility/map" ], function (map_12, exports) {
        /**
        ...
        var AnimationCollection = function () {
            function AnimationCollection(renderer, style) {
                ...
                this._animationDelays = new map_12.Map();
    ...
    def("renderers/null", [ "renderers/clocks/base", "renderers/settings", "settings" ], function (base_2, settings_7, settings_8, exports) {
        /**
        ...
        var NullRenderer = function () {
            function NullRenderer(ass, clock, settings) {
                ...
                this._settings = settings_7.RendererSettings.from(settings);
    ...
    def("renderers/clocks/manual", [ "utility/mixin", "utility/map", "renderers/clocks/base" ], function (mixin_2, map_10, base_1, exports) {
        /**
    ...
    def("parser/index", [ "parser/parse", "parser/streams", "parser/stream-parsers" ], function (parse_3, streams_1, stream_parsers_1, exports) {
    ...
    def("parser/stream-parsers", [ "settings", "types/ass", "types/style", "types/dialogue", "types/attachment", "utility/map", "utility/promise", "parser/misc" ], function (settings_4, ass_1, style_2, dialogue_2, attachment_1, map_9, promise_5, misc_7, exports) {
        var Section;
        (function (Section) {
    ...
    def("types/ass", [ "types/dialogue", "types/style", "types/script-properties", "types/misc", "settings", "parser/index", "parser/misc", "utility/map", "utility/promise", "serialization" ], function (dialogue_1, style_1, script_properties_1, misc_5, settings_3, parser, misc_6, map_8, promise_4, serialization_7, exports) {
        /**
        ...
        var ASS = function () {
            ...
            ASS.prototype.addStyle = function (line) {
                ...
                var styleLine = misc_6.parseLineIntoTypedTemplate(line, this._stylesFormatSpecifier);
            ...
            ASS.prototype.addEvent = function (line) {
                ...
                var dialogueLine = misc_6.parseLineIntoTypedTemplate(line, this._dialoguesFormatSpecifier);
            ...
            ASS.fromStream = function (stream, type) {
                ...
                switch (type) {
                  case misc_5.Format.ASS:
                  case "ass":
                    return new parser.StreamParser(stream).ass;

                  case misc_5.Format.SRT:
                  case "srt":
    ...
    def("parser/misc", [ "utility/map" ], function (map_7, exports) {
        /**
    ...
    def("types/dialogue", [ "types/misc", "parser/parse", "parts/index", "serialization", "settings", "utility/map" ], function (misc_4, parse_2, parts, serialization_5, settings_2, map_6, exports) {
        /**
        ...
        var Dialogue = function () {
            function Dialogue(template, ass) {
                ...
                {
                    var normalizedTemplate_2 = new map_6.Map();
    ...
    def("types/style", [ "types/misc", "parser/parse", "serialization", "utility/map" ], function (misc_3, parse_1, serialization_4, map_5, exports) {
        /**
        ...
        var Style = function () {
            function Style(template) {
                {
                    var normalizedTemplate_1 = new map_5.Map();
                    template.forEach(function (value, key) {
    ...
    def("utility/map", [], function (exports) {
         ...
         * @memberOf libjass
         */
        exports.Map = global.Map || SimpleMap;
        if (typeof exports.Map.prototype.forEach !== "function" || function () {
            try {
    ...
    def("utility/set", [], function (exports) {
         ...
         * @memberOf libjass
         */
        exports.Set = global.Set || SimpleSet;
        if (typeof exports.Set.prototype.forEach !== "function" || function () {
            try {
